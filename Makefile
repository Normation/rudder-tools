...
PUBLISH := scripts/rudder-dev/rudder-dev scripts/rudder-setup/rudder-setup scripts/technique-files contrib/inventory-hooks/aws.py public-keys/rudder-security.asc contrib/inventory-hooks/aws.ps1
