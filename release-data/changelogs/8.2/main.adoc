...
* Fixed: Define the "suse" class on SLED systems
    (https://issues.rudder.io/issues/27082[#27082])

==== Web - Config management

* Fixed: Score service does not really clean unmanaged score, only remove them in cache but they are still in database
    (https://issues.rudder.io/issues/26900[#26900])
* Fixed: In hook template, RUDDER_POLICIES_DIRECTORY comments is false
    (https://issues.rudder.io/issues/27232[#27232])
* Fixed: Many diffs no longer display in event logs 
    (https://issues.rudder.io/issues/27114[#27114])
