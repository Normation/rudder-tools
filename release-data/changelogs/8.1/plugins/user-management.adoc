...
== user-management-8.1.12-2.2 (2025-02-27)
...
== user-management-8.1.11-2.2 (2025-01-13)
...
* Fixed: A user should not be able to delete themselvess in user management
    (https://issues.rudder.io/issues/25464[#25464])
* Fixed: A users should not be able to disable themselves in user management
...
* Fixed: Misleading placeholder for empty field value
