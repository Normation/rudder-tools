...
Rudder 9.1 is currently a maintained version of Rudder.
...
* The configuration exceptions hierarchy is now visible.
...
* The available updates can be viewed by group (like it was already possible with vulnerabilities)
...
More tables include a button to explore the content as CSV,
