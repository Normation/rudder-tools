...
* Fixed: Strict mode of file_key_value_present_option does not introduce unwanted escaping characters
...
* Add scripts to setup Rust build environments in CI
...
* Fixed: Backport new inventory prioritisation, software deletion API and log correction in 6.1
...
* Fixed: Correct documentation about array merge for node properties
...
* Fixed: Array as root json are seen as string
...
* Fixed: Fiber error when postgres is unavailable breaks generation forever
...
* Fixed: Resource path of a technique with a category different than default category are wrong
...
* Fixed: Missing resources feature in technique editor doc
...
* Fixed: When there is a serialisation error for parameter, their edit screen is unavailable
...
* Fixed: All package script should be set -e
    (https://issues.rudder.io/issues/17687[#17687])
* Fixed: Upgrade to 6.1 fails on httpd start because of old ncf conf is still present on rpm
...
* Fixed: Plugin expiration warning misalignment problem
...
* Fixed: add rudder-synchronize within Rudder
...
* Fixed: Add explanation to setup technique editor in development environment in 6.1
...
* Add Bcrypt support information
...
* Full review of rudder-lang supported systems
...
* rl allow split global variables declaration
    (https://issues.rudder.io/issues/16774[#16774])
* rl enhance variables handling
