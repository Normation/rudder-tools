...
* https://issues.rudder.io/issues/18995[#18995]: We fixed lock issues in Rudder server logic, this should make Rudder safer and faster and thus we recommend all users to update to 6.2.3
* https://issues.rudder.io/issues/18832[#18832]: Sometimes, the agent processes were piling up, exhausting resources of the machine, this has been fixed, another important reason to update to 6.2.3
