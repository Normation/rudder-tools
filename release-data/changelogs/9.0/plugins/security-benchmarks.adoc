...
== security-benchmarks-9.0.9-1.2 (2026-08-06)
...
== security-benchmarks-9.0.8-1.2 (2026-07-12)
...
* Show policy mode override and inheritance
    (https://issues.rudder.io/issues/28833[#28833])

=== Bug fixes

==== Miscellaneous

* Fixed: Open group/node tabs are closed and node count goes to 0 when saving
    (https://issues.rudder.io/issues/28932[#28932])

=== Release notes

This is a bug fix release in the 9.0 series and therefore all installations of 9.0.x should be upgraded when possible. When we release a new version of Rudder it has been thoroughly tested, and we consider the release enterprise-ready for deployment.

== security-benchmarks-9.0.7-1.2 (2026-06-12)
...
== security-benchmarks-9.0.6-1.2 (2026-05-04)
...
== security-benchmarks-9.0.5-1.2 (2026-04-02)
...
== security-benchmarks-9.0.4-1.2 (2026-02-16)
...
== security-benchmarks-9.0.3-1.2 (2025-12-22)
...
* Document at caution level that security benchmark changes configuration
    (https://issues.rudder.io/issues/27263[#27263])

=== Bug fixes

==== Miscellaneous

* Fixed: Apply spotless to security-benchmarks
    (https://issues.rudder.io/issues/28061[#28061])
* Fixed: Technique might get disabled during a difficult upgrade or uninstal, and there is no way to reenable them
    (https://issues.rudder.io/issues/27745[#27745])

=== Release notes

This is a bug fix release in the 9.0 series and therefore all installations of 9.0.x should be upgraded when possible. When we release a new version of Rudder it has been thoroughly tested, and we consider the release enterprise-ready for deployment.

== security-benchmarks-9.0.2-1.2 (2025-12-10)
...
* Add group compliance api, node and group should be adapted to look like benchmark compliance
    (https://issues.rudder.io/issues/27949[#27949])
...
* Fixed: Persistent benchmark score even if the node is not in the target group anymore
    (https://issues.rudder.io/issues/27922[#27922])
* Fixed: Unselect of a score does not work when all score are selected
    (https://issues.rudder.io/issues/27592[#27592])

=== Release notes

This is a bug fix release in the 9.0 series and therefore all installations of 9.0.x should be upgraded when possible. When we release a new version of Rudder it has been thoroughly tested, and we consider the release enterprise-ready for deployment.

== security-benchmarks-9.0.1-1.2 (2025-11-19)
...
* Fixed: Remove Rudder Security Checks from the plugin security benchmark
    (https://issues.rudder.io/issues/27804[#27804])
* Fixed: Remove Rudder Security Checks from the plugin security benchmark
    (https://issues.rudder.io/issues/27804[#27804])
* Fixed: Still some beta tags in security benchmark page 
    (https://issues.rudder.io/issues/27814[#27814])
* Fixed: Security benchmarks trembling interface
    (https://issues.rudder.io/issues/27673[#27673])
