...
groups
* Get all inventory data from a node using the REST API
...
work with versions containing more digits like ``5.10.1''
...
* Fixed: Inconsistencies on generated promise due to bug on comparison
logic between them
...
* Fixed: On AIX, check-rudder-agent script complains uses nonexistent
...
* Fixed: Update references in documentation to Rudder 2.10
