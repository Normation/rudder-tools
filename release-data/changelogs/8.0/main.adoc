...
* Fixed: Content of warning tooltip for unknown method should not overflow
...
* Fixed: Migration of techniques is failing when there is a resource.
...
* Fixed: String node properties are displayed in quotes
...
* Fixed: Clean-up unsupported old format for expected report and techniques
