...
* Fixed: Job scheduler methods with mode are broken
...
* Fixed: When upgrading Rudder, the Windows plugins is not enabled
...
* Fixed: When I save a Directive, after clicking ``save'', it’s not
