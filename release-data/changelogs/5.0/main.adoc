...
== Known issues in Rudder

=== Communication between Rudder server 5.0 and agents 4.3 and older
...
rhel 6, rhel 7.3 or older, or sles 12SP3 or older cannot communicate
...
=== Communication between agents 5.0.0 to 5.0.2 and other built with 1.1.0 vs. 1.0.x openssl versions

This is the same problem as above but for differents versions.
